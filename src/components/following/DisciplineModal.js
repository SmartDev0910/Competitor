...
const DisciplineModal = ({modalVisible, setModalVisible}) => {
  ...
  const DisciplineView = DisciplinesData.map((item, index) => {
    return (
      <DisciplineItem
        key={index}
        icon={item.icon}
        ...
        <Modal animationType="slide" transparent={true} visible={modalVisible}>
          ...
          <View style={styles.ModalView}>
            <View style={styles.Appbar}>
              <Text style={styles.ModalTitleFont}>Discipline</Text>
              <TouchableOpacity
            ...
            <ScrollView>
              <View style={styles.ModalContentView}>{DisciplineView}</View>
            </ScrollView>
