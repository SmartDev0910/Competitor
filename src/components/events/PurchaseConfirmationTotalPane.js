...
const PurchaseConfirmationTotalPane = ({collapsed, onCollapse}) => {
  return (
    <View style={styles.Wrapper}>
      <View
        ...
        <View style={styles.ActionView}>
          <Badge text={'$256'} style={styles.BadgeView} />
          <TouchableOpacity
        ...
        <>
          <View style={styles.ContentView}>
            <View style={styles.ContentRowView}>
              ...
              <Text style={styles.ContentItemFont}>$320</Text>
            </View>
            <View style={styles.ContentRowView}>
              <Text style={styles.ContentItemFont}>Taxes</Text>
              <Text style={styles.ContentItemFont}>$16</Text>
            </View>
            <View style={styles.ContentRowView}>
              <Text style={styles.ContentTotalTextFont}>Total</Text>
              <Text style={styles.ContentTotalTextFont}>$336</Text>
            </View>
          </View>
...
export default PurchaseConfirmationTotalPane;
