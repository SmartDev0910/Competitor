      ...
      <Modal animationType="slide" transparent={true} visible={modalVisible}>
        ...
        <View style={styles.ModalView}>
          ...
          <View style={styles.ModalContentView}>
            <StatusHelpItem
              image={ShopingCartIcon}
              title={`Availability: ${available} remaining`}
            />
            <StatusHelpItem
              image={UsDollarCircledIcon}
              title={`Price: $${price}`}
            />
            <StatusHelpItem image={CalendarIcon} title={`Rate: ${rate} rate`} />
            <StatusHelpItem
              image={NewDocumentIcon}
              title="Details:"
