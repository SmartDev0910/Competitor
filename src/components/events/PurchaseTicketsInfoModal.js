...
const PurchaseTicketsInfoModal = ({
  modalVisible,
  setModalVisible,
  title,
  available,
    ...
    <SafeAreaView>
      <Modal animationType="slide" transparent={true} visible={modalVisible}>
        ...
        <View style={styles.ModalView}>
          <Text style={styles.ModalTitleFont}>{'More'}</Text>
          <View style={styles.ModalContentView}>
            <StatusHelpItem image={TwoTicketsIcon} title={title} />
            <StatusHelpItem
              image={ClockIcon}
...
export default PurchaseTicketsInfoModal;
