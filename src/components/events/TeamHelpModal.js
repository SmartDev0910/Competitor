...
const TeamHelpModal = ({modalVisible, setModalVisible}) => {
  return (
    <SafeAreaView>
      <Modal animationType="slide" transparent={true} visible={modalVisible}>
        <View style={styles.OverlayStyle} />
        <View style={styles.ModalView}>
          <Text style={styles.ModalTitleFont}>Team</Text>
          <View style={styles.ModalContentView}>
            <StatusHelpItem
              image={PublicSafetyIcon}
              title="Authorized?"
              content="You can register Authorized people for this event, send them paperwork to sign and bills to pay. 

              You cannot register Unauthorized people for this event. But - you can send them paperwork to sign and bills to pay.
              
              You can register your own horses and horses owned by Authorized team members."
            />
            <StatusHelpItem
