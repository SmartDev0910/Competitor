...
import PurchaseTicketsInfoModal from './PurchaseTicketsInfoModal';

const PurchaseTicketsPaneItem = ({title, available, price, amount, info}) => {
  const [amountText, setAmountText] = React.useState('');
  const [showTicketsInfo, setShowTicketsInfoModal] = React.useState(false);
  ...
  return (
    <>
      ...
      <PurchaseTicketsInfoModal
        modalVisible={showTicketsInfo}
        setModalVisible={setShowTicketsInfoModal}
        title={title}
        available={available}
        price={price}
      />
...
export default PurchaseTicketsPaneItem;
