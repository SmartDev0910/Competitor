      ...
      <ScrollView style={styles.Wrapper}>
        <View>
          <View style={styles.Appbar}>
            ...
            <Text style={styles.AppbarTextFont}>USEF number</Text>
          </View>
          <View style={styles.ContentView}>
            <Text style={styles.DescTextFont}>
              {`Enter your USEF number to sync your profile with the USEF. This will ensure your profile data is always accurate.`}
            </Text>
            <IconLabeledText
              icon={UsefLogo1Image}
